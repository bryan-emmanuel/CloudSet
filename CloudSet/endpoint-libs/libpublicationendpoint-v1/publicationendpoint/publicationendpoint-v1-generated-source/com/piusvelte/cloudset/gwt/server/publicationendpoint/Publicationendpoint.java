...
public class Publicationendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "publicationendpoint/v1/";
  ...
  public class PublicationEndpoint {
     ...
     * operation.
     *
     * @param content the {@link com.piusvelte.cloudset.gwt.server.publicationendpoint.model.Publication}
     * @return the request
     */
    public Publish publish(com.piusvelte.cloudset.gwt.server.publicationendpoint.model.Publication content) throws java.io.IOException {
    ...
    public class Publish extends PublicationendpointRequest<Void> {
       ...
       * @since 1.13
       */
      protected Publish(com.piusvelte.cloudset.gwt.server.publicationendpoint.model.Publication content) {
        super(Publicationendpoint.this, "POST", REST_PATH, content, Void.class);
      }
